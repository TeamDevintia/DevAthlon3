...
/**
 * Sounds sorted in different categories
 *
 * @author Shad0wCore
 */
enum BlockSoundType {
    ...
    /**
     * Fetches a sound category by a legacy id
     *
     * @param id the legacy material id
     * @return the sound of that material
     */
    ...
    /**
     * Fetches a sound category via a materila
     *
     * @param material the material the sound should match too
     * @return the sound of that material
     */
    ...
    /**
     * @return the sound for this category
     */
