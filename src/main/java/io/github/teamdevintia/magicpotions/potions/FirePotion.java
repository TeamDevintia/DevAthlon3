...
import io.github.teamdevintia.magicpotions.visuals.potion.FireSplashVPacket;
import io.github.teamdevintia.magicpotions.visuals.potion.trails.FireTrailVPacket;
...
public class FirePotion extends MagicPotion {
    ...
    public FirePotion(MagicPotions magicPotions) {
        super(magicPotions, "FirePotion", magicPotions.getItemConstant().get("item.firePotion"));
    }
