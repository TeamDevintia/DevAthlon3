...
public abstract class MagicCommand extends BukkitCommand {
    ...
    public MagicCommand(Devathlon3 instance, String name) {
        super(name);
        this.instance = instance;
    }

    public MagicCommand(Devathlon3 instance, String name, String description, String usageMessage, List<String> aliases) {
